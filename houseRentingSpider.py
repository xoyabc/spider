    ...
    def run(self):
        ...
        try:
            ...
            def urlList(page_number):
                ...
                douban_url = [#'https://www.douban.com/group/search?cat=1013&sort=time&q='
                              'https://www.douban.com/group/search?start=' + num_in_url +'&group=beijingzufang&cat=1013&sort=time&q=',
                              ...
                              'https://www.douban.com/group/search?start=' + num_in_url +'&group=26926&cat=1013&sort=time&q=',
                              'https://www.douban.com/group/search?start=' + num_in_url +'&group=sweethome&cat=1013&sort=time&q=',
                ...
                return douban_url
            douban_url_name = [u'北京租房', u'北京租房（非中介）', u'北京个人租房 （真房源|无中介）', u'北京租房豆瓣', u'北京租房（密探）', \
                              u'北京无中介租房（寻天使投资）', u'北京出租房（请自觉统一标题格式）', u'北京租房房东联盟(中介勿扰) ']
